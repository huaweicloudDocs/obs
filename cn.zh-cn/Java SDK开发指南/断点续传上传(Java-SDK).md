# 断点续传上传\(Java SDK\)<a name="obs_21_0611"></a>
...
## 接口约束<a name="section02681816122711"></a>
...
obsClient.uploadFile\([UploadFileRequest](#table16612123611412) [request](#table1824117496403)\)

## 请求参数说明<a name="section1717331917192"></a>

**表 1**  uploadFile请求参数

|**参数**|**类型**|**是否必选**|**描述**|
|--|--|--|--|
|request|UploadFileRequest|是|**参数解释：**上传对象请求参数，详见UploadFileRequest。|


**表 2**  UploadFileRequest
...
|objectMetadata|ObjectMetadata|可选|**参数解释：**对象元数据，详见ObjectMetadata。**默认取值：**无|
...
|progressListener|ProgressListener|可选|**参数解释：**设置数据传输监听器，用于获取上传进度。详见ProgressListener|
...
## 返回结果说明<a name="section443985513216"></a>

**表 22**  CompleteMultipartUploadResult
...
## 代码示例<a name="section142151920373"></a>
