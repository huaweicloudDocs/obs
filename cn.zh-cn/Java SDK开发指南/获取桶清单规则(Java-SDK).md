...
|configurationId|String|是|**参数解释：**清单配置的id。**约束限制：**最长64字节,必须由以下字符组成"a-z"、"A-Z"、"0-9"、"-"、"_"和"."**默认取值：**无|


## 返回结果说明<a name="section127687561478"></a>

**表 2**  GetInventoryConfigurationResult
...
|inventoryConfiguration|InventoryConfiguration|**参数解释**：桶清单配置规则，详见InventoryConfiguration。|
