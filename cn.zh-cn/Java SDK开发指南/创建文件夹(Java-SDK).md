# 创建文件夹\(Java SDK\)<a name="obs_21_0605"></a>
...
## 代码示例<a name="section1507105019166"></a>

本示例用于在examplebucket桶中利用上传对象操作创建parent\_directory/ 文件夹。
...
-   通过API创建文件夹，本质上来说是创建了一个大小为0且对象名以“/”结尾的对象。
-   更多关于创建文件夹的示例代码，请参见[Github示例](https://github.com/huaweicloud/huaweicloud-sdk-java-obs/blob/master/app/src/test/java/samples_java/CreateFolderSample.java)。
-   创建文件夹过程中返回的错误码含义、问题原因及处理措施可参考[OBS错误码](https://support.huaweicloud.com/api-obs/obs_04_0115.html#section1)。
