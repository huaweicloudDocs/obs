# 文件上传\(Java SDK\)<a name="obs_21_0603"></a>
...
-   单次上传对象大小范围是\[0, 5GB\]。
-   如果需要上传超过5GB的大文件，需要通过[分段上传](分段上传(Java-SDK).md)来分段上传。

## 方法定义<a name="section54232412"></a>

obsClient.putObject\([PutObjectRequest](#table8474713764) [request](#table1210700)\)
...
## 代码示例<a name="section373585361714"></a>
