# 获取自定义元数据\(Java SDK\)<a name="obs_21_0707"></a>

## 功能说明<a name="section1826451"></a>

元数据（Metadata）为描述对象属性的信息，是一组键值对，用作对象管理的一部分。
...
## 代码示例<a name="section582118843013"></a>

本示例通过下载examplebucket桶中的objectname对象成功后，返回自定义元数据。示例代码如下：
...
-   拥有对象读权限的用户可以[执行HEAD操作命令](https://support.huaweicloud.com/api-obs/obs_04_0084.html)获取对象元数据，返回信息包含对象的元数据信息。
