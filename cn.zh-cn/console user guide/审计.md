...
5.  开通数据类事件追踪。
    ...
    4.  配置相关参数，参数说明如所示。
        ...
        **表 2**  云审计追踪器参数说明
        ...
        <td class="cellrowborder" valign="top" width="46%" headers="mcps1.2.4.1.3 "><p id="p18891019612"><a name="p18891019612"></a><a name="p18891019612"></a>详细内容请见<a href="#table1245183416315">表3</a>。</p>
        </td>
        </tr>
