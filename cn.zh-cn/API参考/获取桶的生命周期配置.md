# 获取桶的生命周期配置<a name="ZH-CN_TOPIC_0100846756"></a>
...
<LifecycleConfiguration xmlns="http://obs.cn-north-1.myhuaweicloud.com/doc/2015-06-30/"> 
    <Rule> 
        <ID>id</ID> 
...
<td class="cellrowborder" valign="top" width="62.629999999999995%" headers="mcps1.2.3.1.2 "><p id="p54741087"><a name="p54741087"></a><a name="p54741087"></a>表示规则生效的时间。</p>
<p id="p22907739"><a name="p22907739"></a><a name="p22907739"></a>该值必须兼容ISO8601格式，而且必须是UTC午夜0点。</p>
...
<td class="cellrowborder" valign="top" width="62.629999999999995%" headers="mcps1.2.3.1.2 "><p id="p43441451"><a name="p43441451"></a><a name="p43441451"></a>表示在对象创建时间后第几天时规则生效。</p>
<p id="p55428740"><a name="p55428740"></a><a name="p55428740"></a>类型：正整数</p>
