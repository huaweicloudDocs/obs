...
<td class="cellrowborder" valign="top" width="53%" headers="mcps1.2.4.1.2 "><p id="p66300817"><a name="p66300817"></a><a name="p66300817"></a>按SHA安全加密标准计算出消息体的SHA256摘要字符串，即消息体256-bit SHA256值经过base64编码后得到的字符串。</p>
</td>
