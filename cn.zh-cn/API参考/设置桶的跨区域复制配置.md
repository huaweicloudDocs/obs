...
<td class="cellrowborder" valign="top" width="53%" headers="mcps1.2.4.1.2 "><p id="p1145731919332"><a name="p1145731919332"></a><a name="p1145731919332"></a><span>按照RFC 1864标准计算出消息体的MD5摘要字符串，即消息体128-bit MD5值经过base64编码后得到的字符串。</span></p>
</td>
