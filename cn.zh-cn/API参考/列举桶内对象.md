# 列举桶内对象<a name="ZH-CN_TOPIC_0100846736"></a>
...
<p id="p20260863"><a name="p20260863"></a><a name="p20260863"></a>约束：不能为空字符串</p>
</td>
...
该请求使用公共的请求消息头，具体如[表3](REST-API介绍.md#table25197309)所示。
...
Date: date
x-obs-bucket-location: cn-north-1
...
<table><thead align="left"><tr id="row5816417"><th class="cellrowborder" valign="top" width="50%" id="mcps1.2.3.1.1"><p id="p1367796"><a name="p1367796"></a><a name="p1367796"></a><strong id="b12310166"><a name="b12310166"></a><a name="b12310166"></a>元素名称</strong></p>
</th>
<th class="cellrowborder" valign="top" width="50%" id="mcps1.2.3.1.2"><p id="p57599360"><a name="p57599360"></a><a name="p57599360"></a><strong id="b48632194"><a name="b48632194"></a><a name="b48632194"></a>描述</strong></p>
</th>
</tr>
</thead>
<tbody><tr id="row46893646"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p40288978"><a name="p40288978"></a><a name="p40288978"></a>ListBucketResult</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p42181815"><a name="p42181815"></a><a name="p42181815"></a>桶中对象列表。</p>
<p id="p44092021"><a name="p44092021"></a><a name="p44092021"></a>类型：XML</p>
</td>
</tr>
<tr id="row61283877"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p65046979"><a name="p65046979"></a><a name="p65046979"></a>Contents</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p34313913"><a name="p34313913"></a><a name="p34313913"></a>对象的元数据信息。</p>
...
<tr id="row50345523"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p51455566"><a name="p51455566"></a><a name="p51455566"></a>CommonPrefixes</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p7151293"><a name="p7151293"></a><a name="p7151293"></a>请求中带delimiter参数时，返回消息带CommonPrefixes分组信息。</p>
...
<tr id="row45910321"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p27748482"><a name="p27748482"></a><a name="p27748482"></a>Delimiter</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p33034564"><a name="p33034564"></a><a name="p33034564"></a>请求中携带的delimiter参数。</p>
...
<tr id="row4028061"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p57837514"><a name="p57837514"></a><a name="p57837514"></a>ETag</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p54327039"><a name="p54327039"></a><a name="p54327039"></a>对象的MD5值。(当对象是服务端加密的对象时，ETag值不是对象的MD5值。)</p>
...
<tr id="row13854468401"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p1085411613409"><a name="p1085411613409"></a><a name="p1085411613409"></a>Type</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p1128926124012"><a name="p1128926124012"></a><a name="p1128926124012"></a>对象类型，非Normal对象时返回。</p>
...
<tr id="row10182162"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p19448771"><a name="p19448771"></a><a name="p19448771"></a>ID</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p31846650"><a name="p31846650"></a><a name="p31846650"></a>对象拥有者的租户ID。</p>
...
<tr id="row63649794"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p55359666"><a name="p55359666"></a><a name="p55359666"></a>IsTruncated</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p54947971"><a name="p54947971"></a><a name="p54947971"></a>表明是否本次返回的ListBucketResult结果列表被截断。“true”表示本次没有返回全部结果；“false”表示本次已经返回了全部结果。</p>
...
<tr id="row60188292"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p43413469"><a name="p43413469"></a><a name="p43413469"></a>Key</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p26830099"><a name="p26830099"></a><a name="p26830099"></a>对象名。</p>
...
<tr id="row30462839"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p51570899"><a name="p51570899"></a><a name="p51570899"></a>LastModified</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p16493287"><a name="p16493287"></a><a name="p16493287"></a>对象最近一次被修改的时间。</p>
...
<tr id="row11120194"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p28320555"><a name="p28320555"></a><a name="p28320555"></a>Marker</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p12263624"><a name="p12263624"></a><a name="p12263624"></a>列举对象时的起始位置。</p>
...
<tr id="row14703509"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p50133572"><a name="p50133572"></a><a name="p50133572"></a>NextMarker</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p34287556"><a name="p34287556"></a><a name="p34287556"></a>如果本次没有返回全部结果，响应请求中将包含此字段，用于标明本次请求列举到的最后一个对象。后续请求可以指定Marker等于该值来列举剩余的对象。</p>
...
<tr id="row31131430"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p38617862"><a name="p38617862"></a><a name="p38617862"></a>MaxKeys</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p41039090"><a name="p41039090"></a><a name="p41039090"></a>列举时最多返回的对象个数。</p>
...
<tr id="row54052723"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p16194462"><a name="p16194462"></a><a name="p16194462"></a>Name</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p36683058"><a name="p36683058"></a><a name="p36683058"></a>本次请求的桶名。</p>
...
<tr id="row32621445"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p25091397"><a name="p25091397"></a><a name="p25091397"></a>Owner</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p19137257"><a name="p19137257"></a><a name="p19137257"></a>用户信息，包含用户DomainId和用户名。</p>
...
<tr id="row59525802"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p56860664"><a name="p56860664"></a><a name="p56860664"></a>Prefix</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p42311111"><a name="p42311111"></a><a name="p42311111"></a>对象名的前缀，表示本次请求只列举对象名能匹配该前缀的所有对象。类型：字符串</p>
<p id="p45255687"><a name="p45255687"></a><a name="p45255687"></a>父节点：ListBucketResult</p>
</td>
</tr>
<tr id="row4647999"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p40943623"><a name="p40943623"></a><a name="p40943623"></a>Size</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p28099143"><a name="p28099143"></a><a name="p28099143"></a>对象的字节数。</p>
...
<tr id="row16072172"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p26777569"><a name="p26777569"></a><a name="p26777569"></a>StorageClass</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p21499466"><a name="p21499466"></a><a name="p21499466"></a>对象的存储类型。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p2431675"><a name="p2431675"></a><a name="p2431675"></a>对象的MD5值。</p>
...
## 请求实例1<a name="section4967514913"></a>
...
## 响应实例1<a name="section61601145011"></a>
...
## 请求实例2<a name="section535111413214"></a>

**筛选对象**

用户有桶名为examplebucket，桶内共有三个名为newfile,obj0001,obj002的对象，如果只列需要查看对象名为obj002的对象，请求消息格式为：
...
## 响应实例2<a name="section76081155815"></a>
...
## 请求实例3<a name="section10211101623018"></a>
...
## 响应实例3<a name="section16842103705414"></a>
