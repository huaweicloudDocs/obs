...
<td class="cellrowborder" valign="top" width="68.69000000000001%" headers="mcps1.2.4.1.2 "><p id="p60031475"><a name="p60031475"></a><a name="p60031475"></a>列举桶内对象列表时，指定一个标识符，从该标识符以后按字典顺序返回对象列表。</p>
