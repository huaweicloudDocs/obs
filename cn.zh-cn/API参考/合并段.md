...
<td class="cellrowborder" valign="top" width="56.57%" headers="mcps1.2.4.1.2 "><p id="p64009348"><a name="p64009348"></a><a name="p64009348"></a>对应段的ETag值。</p>
...
<td class="cellrowborder" valign="top" width="72.72999999999999%" headers="mcps1.2.3.1.2 "><p id="p14498642"><a name="p14498642"></a><a name="p14498642"></a>根据各个段的ETag计算得出的结果。</p>
...
## 请求实例<a name="section74706439232"></a>
...
## 响应实例<a name="section8740182716598"></a>
