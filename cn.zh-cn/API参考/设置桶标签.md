...
<td class="cellrowborder" valign="top" width="53.260000000000005%" headers="mcps1.2.4.1.2 "><p id="p179925362264"><a name="p179925362264"></a><a name="p179925362264"></a>按照RFC 1864标准计算出消息体的MD5摘要字符串，即消息体128-bit MD5值经过base64编码后得到的字符串。</p>
<p id="p3992123610265"><a name="p3992123610265"></a><a name="p3992123610265"></a>类型：字符串</p>
