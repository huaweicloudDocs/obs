...
<td class="cellrowborder" valign="top" width="50.06%" headers="mcps1.2.3.1.2 "><p id="p65180310"><a name="p65180310"></a><a name="p65180310"></a>用户的DomainID（账号ID）。</p>
...
<td class="cellrowborder" valign="top" width="50.06%" headers="mcps1.2.3.1.2 "><p id="p13195950171917"><a name="p13195950171917"></a><a name="p13195950171917"></a>用户的DomainName（账号名）。</p>
