...
<td class="cellrowborder" valign="top" width="52.53%" headers="mcps1.2.4.1.2 "><p id="p30710946"><a name="p30710946"></a><a name="p30710946"></a>表示规则生效的时间。</p>
<p id="p7963060"><a name="p7963060"></a><a name="p7963060"></a>该值必须兼容ISO8601格式，而且必须是UTC午夜0点。</p>
...
<td class="cellrowborder" valign="top" width="52.53%" headers="mcps1.2.4.1.2 "><p id="p28708642"><a name="p28708642"></a><a name="p28708642"></a>表示在对象创建时间后第几天时规则生效（仅针对对象的最新版本）。</p>
