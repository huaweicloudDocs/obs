# 列举已上传的段<a name="ZH-CN_TOPIC_0100846791"></a>

## 功能介绍<a name="section5584184924715"></a>

用户可以通过本接口查询一个任务所属的所有段信息。
...
<ListPartsResult xmlns="http://obs.cn-north-1.myhuaweicloud.com/doc/2015-06-30/"> 
...
<p id="p1701594"><a name="p1701594"></a><a name="p1701594"></a>类型：容器。</p>
...
<td class="cellrowborder" valign="top" width="73.74000000000001%" headers="mcps1.2.3.1.2 "><p id="p37313061"><a name="p37313061"></a><a name="p37313061"></a>已上传Part内容的ETag。</p>
...
## 请求实例<a name="section138791052194818"></a>
...
## 响应实例<a name="section418123615543"></a>
