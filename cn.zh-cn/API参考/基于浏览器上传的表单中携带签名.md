...
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.2.3.1.2 "><p id="p20267479113732"><a name="p20267479113732"></a><a name="p20267479113732"></a>上传成功后的重定向URL地址。</p>
...
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.2.3.1.2 "><p id="p65023749113732"><a name="p65023749113732"></a><a name="p65023749113732"></a>如果未指定success_action_redirect，则成功上传时返回给客户端的状态码。支持精确匹配。</p>
</td>
</tr>
