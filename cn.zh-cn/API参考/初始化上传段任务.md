...
<td class="cellrowborder" valign="top" width="67.35%" headers="mcps1.2.4.1.2 "><p id="p038312375711"><a name="p038312375711"></a><a name="p038312375711"></a>表示上传对象的过期时间，单位是天。</p>
...
其他公共消息头请参考[表3](REST-API介绍.md#table25197309)。
...
<InitiateMultipartUploadResult xmlns="http://obs.cn-north-1.myhuaweicloud.com/doc/2015-06-30/"> 
...
<p id="p127014384366"><a name="p127014384366"></a><a name="p127014384366"></a>格式为： regionID:domainID(租户ID):key/key_id. 其中regionID是使用秘钥所属region的ID；domainID是使用秘钥所属租户的租户ID；key_id是本次加密使用的秘钥ID。</p>
<p id="p0270153811366"><a name="p0270153811366"></a><a name="p0270153811366"></a>示例： x-obs-server-side-encryption-kms-key-id：cn-north-1:domainiddomainiddomainiddoma0001:key/4f1cd4de-ab64-4807-920a-47fc42e7f0d0</p>
</td>
</tr>
...
## 请求实例1<a name="section14231133313369"></a>
...
## 响应实例1<a name="section6143226163010"></a>
...
## 请求实例2<a name="section123644113018"></a>
...
## 响应实例2<a name="section199516233110"></a>
