...
<td class="cellrowborder" valign="top" width="66%" headers="mcps1.2.3.1.2 "><p id="p28772013182217"><a name="p28772013182217"></a><a name="p28772013182217"></a>支持通过IAM策略、桶策略&amp;对象策略和桶/对象ACL对OBS进行访问控制。</p>
</td>
</tr>
