...
6.  配置如下参数，授予匿名用户访问文件夹内对象的权限。
    ...
    **表 1**  授予访问桶的权限的参数配置
    ...
    <td class="cellrowborder" valign="top" width="78.05%" headers="mcps1.2.3.1.2 "><a name="ul12411915123314"></a><a name="ul12411915123314"></a><ul id="ul12411915123314"><li>包含</li><li>选择“指定资源”</li><li>配置为选中文件夹内的所有对象，如文件夹名称为“folder-001”时，资源值为“folder-001/*”。</li></ul>
    </td>
    </tr>
