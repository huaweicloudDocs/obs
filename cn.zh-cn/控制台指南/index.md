...
-   [桶的访问权限](桶的访问权限.md)
    ...
    -   [配置桶ACL](配置桶ACL.md)
    -   [配置桶策略](配置桶策略.md)
    -   [应用示例一-桶拥有者为IAM用户授予桶权限](应用示例一-桶拥有者为IAM用户授予桶权限.md)
    -   [应用示例二-桶拥有者为其他账号授予桶权限](应用示例二-桶拥有者为其他账号授予桶权限.md)
    -   [应用示例三-为匿名用户设置文件夹的访问权限](应用示例三-为匿名用户设置文件夹的访问权限.md)
    -   [应用示例四-限制特定地址对桶的访问权限](应用示例四-限制特定地址对桶的访问权限.md)
    -   [应用示例五-限制桶中对象的访问起始时间和结束时间](应用示例五-限制桶中对象的访问起始时间和结束时间.md)
...
-   [对象的访问权限](对象的访问权限.md)
    ...
    -   [配置对象策略](配置对象策略.md)
    -   [应用示例一-为匿名用户设置对象的访问权限](应用示例一-为匿名用户设置对象的访问权限.md)
    -   [应用示例二-为匿名用户设置文件夹的访问权限](应用示例二-为匿名用户设置文件夹的访问权限.md)
