...
5.  在域名解析服务器上配置CNAME记录，将用户自定义域名（例如www.example.com）映射成桶域名。若您配置了CDN加速，CNAME通过域名管理界面“CNAME”列获取。
    ...
    5.  根据界面提示填写参数配置，参数信息如[表1](#table18826111120149)所示。
        ...
        **表 1**  参数说明
        ...
        <p id="p134423312216"><a name="p134423312216"></a><a name="p134423312216"></a>若没有开启CDN加速，该值为桶域名；若开启CDN加速后，该值为CDN分配的CNAME域名。</p>
        </td>
        <td class="cellrowborder" valign="top" width="33%" headers="mcps1.2.4.1.3 "><p id="p1049743714143"><a name="p1049743714143"></a><a name="p1049743714143"></a>www.test.com.c.cdnhwc1.com</p>
        </td>
        </tr>
